...
tp_simplest_train <- read_csv("input-data/testing-training/tp_simplest_train.csv")

tp_simplest_test <- read_csv("input-data/testing-training/tp_simplest_test.csv")

#### More complex (has antecedents & season)

tp_mrcomp_train <- read_csv("input-data/testing-training/tp_mrcomp_train.csv")

tp_mrcomp_test <- read_csv("input-data/testing-training/tp_mrcomp_test.csv")

#### Most complex (antecedents & watershed attributes)

tp_mstcomp_train <- read_csv("input-data/testing-training/tp_mstcomp_train.csv")

tp_mstcomp_test <- read_csv("input-data/testing-training/tp_mstcomp_test.csv")
...
mstcomp_testing[[3]] %>% mutate(model_type = "most_comp")
